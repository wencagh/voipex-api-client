 ...
 */
class Model15 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Model15';
    ...
    */
     ...
     * Gets user
     *
     * @return \Voipex\Ipbx\Model\Model14|null
     */
    public function getUser(): ?\Voipex\Ipbx\Model\Model14
    {
     ...
     * Sets user
     *
     * @param \Voipex\Ipbx\Model\Model14|null $user user
     *
     * @return $this
     */
    public function setUser(?\Voipex\Ipbx\Model\Model14 $user): static
    {
        if (is_null($user)) {
     ...
     * Gets direction
     *
     * @return \Voipex\Ipbx\Model\Direction|null
     */
    public function getDirection(): ?\Voipex\Ipbx\Model\Direction
    {
     ...
     * Sets direction
     *
     * @param \Voipex\Ipbx\Model\Direction|null $direction direction
     *
     * @return $this
     */
    public function setDirection(?\Voipex\Ipbx\Model\Direction $direction): static
    {
     ...
     * Gets state
     *
     * @return \Voipex\Ipbx\Model\State|null
     */
    public function getState(): ?\Voipex\Ipbx\Model\State
    {
     ...
     * Sets state
     *
     * @param \Voipex\Ipbx\Model\State|null $state state
     *
     * @return $this
     */
    public function setState(?\Voipex\Ipbx\Model\State $state): static
    {
        if (is_null($state)) {
     ...
     * Sets creation_time
     *
     * @param \DateTime|null $creation_time creation_time
     *
     * @return $this
     */
    public function setCreationTime(?\DateTime $creation_time): static
    {
