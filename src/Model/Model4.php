 ...
 */
class Model4 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Model4';
    ...
    */
     ...
     * Sets caller_id
     *
     * @param string|null $caller_id caller_id
     *
     * @return $this
     */
    public function setCallerId(?string $caller_id): static
    {
        if (is_null($caller_id)) {
            array_push($this->openAPINullablesSetToNull, 'caller_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('caller_id', $nullablesSetToNull);
            if ($index !== FALSE) {
