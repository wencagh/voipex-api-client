 ...
 */
class Model32 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Model32';
    ...
    */
     ...
     * Sets channel
     *
     * @param float|null $channel Channel number in stereo recording
     *
     * @return $this
     */
    public function setChannel(?float $channel): static
    {
        if (is_null($channel)) {
