 ...
 */
class Model30 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Model30';
    ...
    */
     ...
     * Sets eventtime
     *
     * @param \DateTime $eventtime Event time in specified timezone
     *
     * @return $this
     */
    ...
    {
        if (is_null($dst)) {
            array_push($this->openAPINullablesSetToNull, 'dst');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dst', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
