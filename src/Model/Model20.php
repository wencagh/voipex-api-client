 ...
 */
class Model20 implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Model20';
    ...
    */
     ...
     * Sets pbx_user_id
     *
     * @param float|null $pbx_user_id pbx_user_id
     *
     * @return $this
     */
     ...
     * @return float|null
     */
    public function getExten(): ?float
    {
     ...
     * Sets exten
     *
     * @param float|null $exten User line number
     *
     * @return $this
     */
    public function setExten(?float $exten): static
    {
        if (is_null($exten)) {
            throw new InvalidArgumentException('non-nullable exten cannot be null');
        }
